...
const Discover = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <div className="relative z-10 pt-[60px] pb-20 md:pt-20 md:pb-12 flex flex-col items-center">
        {/* Clean header */}
        <motion.div
        ...
        {/* Card stack */}
        <div className="relative w-full max-w-sm mx-auto px-4 h-[calc(100dvh-220px)] md:h-[580px]">
          {loading ? (
