...
const ASTRO_EVENTS_2026: Omit<AstroEvent, "active">[] = [
  ...
  { id: "merc-retro-2", title: "Mercury Retrograde", description: "Travel and tech disruptions. Be patient with your connections.", icon: "☿️", startDate: new Date("2026-05-19"), endDate: new Date("2026-06-11"), type: "retrograde", advice: "Revisit past connections. Avoid making major decisions now." },
  { id: "merc-retro-3", title: "Mercury Retrograde", description: "Reflect on what you truly desire in a kindred soul.", icon: "☿️", startDate: new Date("2026-09-12"), endDate: new Date("2026-10-04"), type: "retrograde", advice: "Great time for introspection. Journal about your ideal connection." },
  // Eclipses
  ...
  { id: "lunar-eclipse-1", title: "Lunar Eclipse in Virgo", description: "Release perfectionism in connections. Embrace authenticity.", icon: "🌕", startDate: new Date("2026-03-03"), endDate: new Date("2026-03-03"), type: "eclipse", advice: "Let go of unrealistic expectations. Be real with your connections." },
  ...
  { id: "sagittarius-season", title: "Sagittarius Season", description: "Adventure calls! Expand your social horizons.", icon: "♐", startDate: new Date("2026-11-22"), endDate: new Date("2026-12-21"), type: "season", advice: "Try new types. Be open to different backgrounds." },
