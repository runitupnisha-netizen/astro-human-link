            ...
            >
              <div className="text-center mb-8">
                <div className="relative w-56 h-56 mx-auto mb-2">
                  ...
                  <img src={alignedLogo} alt="Aligned" style={{ filter: 'contrast(1.5) brightness(1.2)' }} className="relative w-56 h-56 object-contain mix-blend-screen drop-shadow-[0_0_25px_hsl(260_60%_65%/0.5)]" />
                </div>
