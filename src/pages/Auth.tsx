      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
           <div className="relative w-56 h-56 mx-auto mb-2">
             ...
             <img src={alignedLogo} alt="Aligned" style={{ filter: 'contrast(3) brightness(1.3)' }} className="relative w-56 h-56 object-contain mix-blend-screen drop-shadow-[0_0_25px_hsl(260_60%_65%/0.5)]" />
           </div>
