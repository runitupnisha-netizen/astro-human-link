...
const onboardingData: DataItem[] = [
  ...
  },
  {
    ...
    purpose: "Shows distance to potential matches in miles. Never shared as exact coordinates with other users.",
    required: true,
  ...
  },
  {
    ...
    purpose: "Shown to other users in Discover and matches. Stored privately and served via signed URLs.",
    required: false,
  ...
  },
  {
    ...
    purpose: "Match filtering and compatibility scoring.",
    required: true,
    retention: "Until you delete your account",
  },
  {
