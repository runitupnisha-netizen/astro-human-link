...
import { completeAuthRedirectFromUrl, isPasswordRecoveryRedirect } from "@/lib/authRedirect";
...
export const useAuth = () => {
  ...
  useEffect(() => {
    ...
    const isRecoveryLink = isPasswordRecoveryRedirect();

    const hydrateOAuthSession = async () => {
      return completeAuthRedirectFromUrl();
    };
