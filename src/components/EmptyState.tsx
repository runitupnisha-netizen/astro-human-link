...
const emptyStates = {
  matches: {
    ...
    description: "Keep exploring — Stellara surfaces aligned souls as you grow.",
    cta: "Keep Exploring",
    route: "/discover",
  ...
  messages: {
    ...
    description: "Your messages will appear here once you make your first Connection.",
  ...
  connections: {
    icon: Users,
    title: "No Connections yet ✦",
    description: "Keep your Blueprint complete — Stellara surfaces aligned souls as you grow.",
    cta: "Explore",
    route: "/discover",
  ...
  discover: {
    icon: Compass,
    title: "The cosmos is aligning. ✦",
    description: "A complete Blueprint helps Stellara surface the most aligned profiles for you.",
